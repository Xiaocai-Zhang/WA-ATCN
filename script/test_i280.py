...
class config:
    ...
    ParaPath = './para/parameter_i280.csv'
    SavePath = './para/test_result_i280.csv'
    seed = 11
...
def Test(x,round_no):
    ...
    np.savetxt('./prediction/I280/prediction.csv', predictions_test, delimiter=',')
    np.savetxt('./prediction/I280/groundtruth.csv', y_test_glo, delimiter=',')
